...
class ImageGeneratorBloc extends Bloc<ImageGeneratorEvent, ImageGeneratorState> {
  ...
  FutureOr<void> initialEvent(InitialEvent event, Emitter<ImageGeneratorState> emit) {
  }

  FutureOr<void> imageGenerateButtonClickEvent(ImageGenerateButtonClickEvent event, Emitter<ImageGeneratorState> emit) {
  }
}
