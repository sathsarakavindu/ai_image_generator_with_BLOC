...
class AppConfig {
  static String api_key = 'vk-uCa3xZ2Q0BFp12JtOyBJSHpUuIuQGdD2z3rNaDZZwSh55bDq';
  static String url = 'https://api.vyro.ai/v2/image/generations/transparent';
  ...
  static String loading_giff = "assets/giff/loading.gif";
}
